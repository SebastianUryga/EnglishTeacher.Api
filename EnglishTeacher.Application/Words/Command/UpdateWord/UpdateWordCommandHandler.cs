...
{
    public class UpdateWordCommandHandler : IRequestHandler<UpdateWordCommand,WordDetialVm>
    {
        ...
        public async Task<WordDetialVm> Handle(UpdateWordCommand request, CancellationToken cancellationToken)
        {
